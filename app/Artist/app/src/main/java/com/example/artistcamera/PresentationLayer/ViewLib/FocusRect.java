...
public class FocusRect extends AppCompatImageView {
    ...
    public FocusRect(Context context) {
        this(context, null, 0);
    }

    public FocusRect(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public FocusRect(Context context, AttributeSet attrs, int defStyleAttr) {
     ...
     * @param y
     */
    public void setTouchFoucusRect(Camera camera, Camera.AutoFocusCallback autoFocusCallback,
                                   float x, float y) {
        //以焦点为中心，宽度为200的矩形框
...
//        if(null != touchFocusRect){//矩形框正在显示
//            if(secondStart ==null){
//                secondStart=System.currentTimeMillis();
//            }
//            else if(secondStart !=null &&
//                    System.currentTimeMillis()-secondStart>=1000){//耗时1s
//                secondStart=null;
//                touchFocusRect=null;
//            }
//        }
